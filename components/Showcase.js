        ...
        <div className={showcaseSty.content}>
          <div className={showcaseSty.head}>
            ...
            <div className={showcaseSty.socialLinks}>
              <a href="https://www.facebook.com/latituduezlongitudez">
                <FaFacebookSquare id={showcaseSty.socialIcon} size={30} />
              </a>
              <a href="https://instagram.com/_longitudez_">
                <FaInstagramSquare id={showcaseSty.socialIcon} size={30} />
              </a>
              <a href="https://twitter.com/longitudez3">
                <FaTwitterSquare id={showcaseSty.socialIcon} size={30} />
              </a>
            </div>
